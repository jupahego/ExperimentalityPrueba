package co.com.experimentality.prueba.utils.runner;
...
public class RunnerPersonalizado extends Runner {
    private static final Logger LOGGER =
            LogManager.getLogger(RunnerPersonalizado.class.getName());
    ...
    public void run(RunNotifier notifier) {
        try {
            ...
            cucumberWithSerenity = new CucumberWithSerenity(classValue);
        } catch (IllegalAccessException | InvocationTargetException | IOException | InitializationError e) {
